...
**Версия контракта:** 2.10.1 · **SemVer-политика:** см. §4.
...
| 2.10.1 | 2026-05-18 | PATCH §3.6: легализация формы аппрува для single-owner режима (COMMENT-review с чеклистом ≡ formal Approve, пока обе команды под одним GitHub-аккаунтом); статус → «Ратифицирован» | `shared/contract-kmz-patch-governance` |
