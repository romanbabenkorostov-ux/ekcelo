...
**Статус:** план. Замена текстового graph на D3/cytoscape + порт KMZ-парсера из viewer/index.html в `adapters/kmz.ts`. DoD: один объект через api и kmz рисуется идентично.
