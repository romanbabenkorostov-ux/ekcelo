...
| Stage 4b: export JSON для viewer | Замена фикстуры на production-источник | план | — |
...
- **Stage 4b: export JSON.** Сейчас viewer работает на фикстуре; после Stage 4b — на экспорте из БД (тот же формат).
