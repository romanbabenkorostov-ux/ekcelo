...
MSK_ZONES: dict[str, MSKZone] = {
    "мск-26-з1": MSKZone(
        ...
        y_0=-4_511_057.628,
        source=(
            "сверено 2026-09-12 на выписках 26:29:130106:382 и 26:29:130106:334: "
            "площадь по контуру 1985.6 / 4415.6 м² против заявленных 1986 / 4416 м², "
            "центроид 43.97°N 42.81°E — Предгорный МО, как в адресе"
        ),
    ),
}
